...
class GraphOperationsBBFS:
    ...
    # def goal_Both(self, currentState, currentStateOfPullMode, whichButterNumber):
    #     currentState_ButtersLocation = - \
    #                                        currentState.getButters() - [whichButterNumber].getLocation()
    #     currentStateOfPullMode_ButtersLocation = - \
    #         currentStateOfPullMode.getButters()[whichButterNumber].getLocation()
    #     currentState_RobotsLocation = - \
    #         currentState.getRobot().getLocation()
    #     currentStateOfPullMode_RobotsLocation = - \
    #         currentStateOfPullMode.getRobot().getLocation()
    #
    #     if currentState_ButtersLocation == currentStateOfPullMode_ButtersLocation and - \
    #             currentState_RobotsLocation == currentStateOfPullMode_RobotsLocation:
    #         return True
    #     return False
    #
    # def successorPush(self, currentNodeBBFS, whichButterNumber):
    #     robotsLocation = currentNodeBBFS.getState().getRobot().getLocation()
    #     wantedButtersLocation = currentNodeBBFS.getState().getButters()[whichButterNumber].getLocation()
    #     whichNeighbours = []
    #     pushList = []
    #     successorList = []
    #
    ...
    #         pushList.append(4)
    #
    # for i in whichNeighbours: if not self.blocks[self.neighbourProducer(i, wantedButtersLocation)[0]][
    # self.neighbourProducer(i, wantedButtersLocation)[1]].getHaveObstacle() or \ self.blocks[self.neighbourProducer(
    # i, wantedButtersLocation)[0]][ self.neighbourProducer(i, wantedButtersLocation)[1]].getHaveButter(): robotTemp
    # = copy(self.robot) robotTemp.setLocation(self.neighbourProducer(i, wantedButtersLocation))
    # successorList.append(NodeBBFS(State(robotTemp, copy(currentNodeBBFS.getState().getButters())), currentNodeBBFS))
    #
    #     for i in pushList:
    ...
    #             successorList.append(NodeBBFS(State(robotTemp, buttersTemp), currentNodeBBFS))
    #
    #     return successorList
    #
    # def successorPull(self, currentNodeBBFS, whichButterNumber):
    #     robotsLocation = currentNodeBBFS.getState().getRobot().getLocation()
    #     wantedButtersLocation = currentNodeBBFS.getState().getButters()[whichButterNumber].getLocation()
    #     whichNeighbours = []
    #     pushList = []
